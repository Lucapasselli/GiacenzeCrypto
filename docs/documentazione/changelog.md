...
- Il **doppio clic su una riga** della tabella dei movimenti apriva il dettaglio in una posizione sbagliata, e le tabelle sotto "Gruppi Wallet Crypto" restavano ferme sul gruppo precedente dopo un cambio di gruppo dalla tabella.
- Nella tabella dei periodi la colonna "Note" perdeva parte del testo, e l'IVAFE sulla liquidità con aliquota privilegiata non veniva mostrata in stampa; un conto aperto e chiuso nello stesso anno spariva dal quadro.
...
- "Trasla Orario" non trascina più movimenti collegati non selezionati che condividevano per caso lo stesso orario.
