...
private static final long serialVersionUID = 9L;
   ...
   // String IDOriginale="";
    ...
    private void initComponents() {
        ...
        Bottone_PrezzoAutomatico.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/24_Prezzo.png"))); // NOI18N
        Bottone_PrezzoAutomatico.setText("Prezzo Automatico");
        Bottone_PrezzoAutomatico.setMaximumSize(new java.awt.Dimension(146, 35));
        Bottone_PrezzoAutomatico.setMinimumSize(new java.awt.Dimension(146, 35));
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(Bottone_Ok, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(P_TextFonte, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(P_TextMoneta, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(18, 18, 18)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(P_TextPU, javax.swing.GroupLayout.DEFAULT_SIZE, 220, Short.MAX_VALUE)
                                    .addComponent(P_TextTimeFonte)))
                            .addGroup(layout.createSequentialGroup()
                                .addGap(42, 42, 42)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(MonetaUscitaAddress_Label, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addContainerGap())
        );
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(10, 10, 10)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(Bottone_Ok, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(Note_ScrollPane, javax.swing.GroupLayout.PREFERRED_SIZE, 97, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(Bottone_Annulla, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addGap(11, 11, 11))
        );
   ...
   /* private void FiltraItemsComboBoxWallet(JComboBox combobox,String filter,JComboBox comboboxTipo,boolean apriMenu) {
    ...
    private void Bottone_OkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Bottone_OkActionPerformed
        ...
        if (!MonetaFonte.isBlank() && !PrezzoUnitario.isBlank()) {
            ...
            else if (MonetaFonte.equals(MonetaE)) {
...
worker.execute();*/
    ...
    private void Bottone_PrezzoAutomaticoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Bottone_PrezzoAutomaticoActionPerformed
        // TODO add your handling code here:
         if (!EvidenziaProblemi()) {
            ...
            Prezzi.InfoPrezzo IPp[]=new Prezzi.InfoPrezzo[1];
            //Oggetto 0 -> Prezzo
            //Oggetto 1 -> Token+"|"+TimeStamp+"|"+PrezzoU+"|"+Fonte;
            ...
            thread = new Thread() {
                ...
                public void run() {
                    String Rete=null;
                    if (ModificaMovimento) Rete=Funzioni.TrovaReteDaID(MovimentoRiportato[0]);
                    IPp[0]=Prezzi.DammiPrezzoInfoTransazione(MU, ME, DataLong, Rete, Fonte);
                    progress.ChiudiFinestra();
                }
            };
            thread.start();
           ...
           // progress.ChiudiFinestra();
            ...
            if (IPp[0]!=null){
             ...
             /*   System.out.println(IPp[0].Fonte);
                ...
                if (IPp[0].timestamp!=0)P_TextTimeFonte.setText(IPp[0].RitornaStringData());else P_TextTimeFonte.setText("");
                if (IPp[0].prezzoQta!=null)ValoreTransazione_TextField.setText(IPp[0].prezzoQta.setScale(2,RoundingMode.HALF_UP).toPlainString());
